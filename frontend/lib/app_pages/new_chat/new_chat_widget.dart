  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<BotsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final newChatBotsRecord = snapshot.data!;
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.network(
                                                newChatBotsRecord.botImagePath,
                                                width: 300.0,
                                                height: 200.0,
                                                fit: BoxFit.cover,
                                              ),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Builder(
                                        builder: (context) {
                                          final hintList = FFAppState()
                                              .hintPromptList
                                              .toList();
                                          return Column(
                                            mainAxisSize: MainAxisSize.max,
                                            children:
                                                List.generate(hintList.length,
                                                    (hintListIndex) {
                                              final hintListItem =
                                                  hintList[hintListIndex];
                                              return Container(
                                                width: double.infinity,
                                                height: 60.0,
                                                decoration: BoxDecoration(
                                                    ...
                                                    onTap: () async {
                                                      setState(() {
                                                        FFAppState()
                                                          ...
                                                          author: 'user',
                                                          content:
                                                              '${hintListItem.title} ${hintListItem.desc}',
                                                        ));
                                                      });
